      ...
      <nav className='fixed top-0 left-0 right-0 bg-white backdrop-blur-md z-50 border-b border-gray-200 shadow-sm'>
        <div className='max-w-7xl mx-auto px-6 py-2 flex items-center justify-between'>
          ...
          <div className='hidden md:flex items-center gap-8'>
            ...
            <a href='#contact' className='bg-gradient-to-r py-1.5 px-2 rounded-lg from-red-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white'>
              Contact Us
            </a>
          </div>
        </div>
      ...
      <section className='py-24 px-6 bg-gray-50'>
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            <VisionMissionCard icon={Eye} title='Vision' />
            <VisionMissionCard icon={Target} title='Mission' />
          </div>
        </div>
      </section>
